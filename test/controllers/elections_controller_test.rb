...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post elections_url, params: { election: { index: @election.index, show: @election.show } }
  #   end
  ...
  #   patch election_url(@election), params: { election: { index: @election.index, show: @election.show } }
