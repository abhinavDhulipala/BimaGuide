...
class JobTest < ActiveSupport::TestCase
  ...
  test 'job validation: job cannot be started while on prior job' do
    @employee.jobs.create!(date_completed: 10.days.ago, duration: 5, total_pay: 80, role: 'guide')
    ...
    assert_not_predicate job2, :persisted?
    assert_includes job2.errors, :date_completed
    assert_equal job2.errors[:date_completed],
  ...
  test 'job validation: presence' do
    ...
    assert_not_predicate job1, :valid?
