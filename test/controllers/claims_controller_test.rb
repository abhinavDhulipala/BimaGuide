...
class ClaimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post claims_url, params: { claim: { amount: @claim.amount, approved: @claim.approved, approver_id: @claim.approver_id, info: @claim.info, occurred: @claim.occured, references: @claim.references, type: @claim.type } }
    end
  ...
  test "should update claim" do
    patch claim_url(@claim), params: { claim: { amount: @claim.amount, approved: @claim.approved, approver_id: @claim.approver_id, info: @claim.info, occurred: @claim.occured, references: @claim.references, type: @claim.type } }
